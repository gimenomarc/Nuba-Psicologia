            ...
            <div className="flex items-start mb-8">
              ...
              <div className="flex-1 pt-2">
                ...
                <p className="text-xl text-gray-700 leading-relaxed mb-6">
                  {t('comoTrabajo.modalidad.texto')}
                </p>
                <p className="text-xl text-gray-700 leading-relaxed">
                  El meu acompanyament es desenvolupa en modalitat online, una forma de treball que ofereix nombrosos avantatges: 
                  permet estalviar temps i desplaçaments, facilita la conciliació amb la vida quotidiana i dona accés a la teràpia 
                  des de qualsevol lloc, sempre en un entorn segur i confidencial.
                </p>
              </div>
            </div>
          </div>
